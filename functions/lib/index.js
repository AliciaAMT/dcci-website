...
exports.backfillYouTubeUploads = exports.syncYouTubeUploads = exports.getStorageUsage = exports.trackPageView = exports.getContactStats = exports.subscribeToNewsletter = exports.testContactForm = exports.submitContactForm = void 0;
...
exports.submitContactForm = functions.https.onRequest((req, res) => {
    return cors(req, res, async () => {
        ...
        const firstForwardedIP = Array.isArray(forwardedFor)
            ? (_a = forwardedFor[0]) === null || _a === void 0 ? void 0 : _a.trim()
            : (_b = forwardedFor === null || forwardedFor === void 0 ? void 0 : forwardedFor.split(',')[0]) === null || _b === void 0 ? void 0 : _b.trim();
        ...
        console.log('Request headers:', {
            ...
            'req.ip': req.ip,
            'remoteAddress': (_e = req.connection) === null || _e === void 0 ? void 0 : _e.remoteAddress
        });
        ...
        const validation = (0, sanitization_1.sanitizeContactForm)({ name, email, subject, message, newsletter, formLoadTime, submissionTime });
        ...
        try {
            ...
            const recentSubmissions = allContacts.docs
                ...
                .sort((a, b) => { var _a, _b; return ((_a = b.data().submittedAt) === null || _a === void 0 ? void 0 : _a.toMillis()) - ((_b = a.data().submittedAt) === null || _b === void 0 ? void 0 : _b.toMillis()); });
            if (recentSubmissions.length > 0) {
                const lastSubmission = recentSubmissions[0].data();
                const lastSubmissionTime = ((_f = lastSubmission.submittedAt) === null || _f === void 0 ? void 0 : _f.toMillis()) || 0;
          ...
          <p><b>Name:</b> ${(0, sanitization_1.escapeHtmlForEmail)(sanitizedName)}</p>
          <p><b>Email:</b> ${(0, sanitization_1.escapeHtmlForEmail)(sanitizedEmail)}</p>
          <p><b>Subject:</b> ${(0, sanitization_1.escapeHtmlForEmail)(sanitizedSubject)}</p>
          <p><b>Newsletter Subscription:</b> ${sanitizedNewsletter ? 'Yes' : 'No'}</p>
          <p><b>IP Address:</b> ${(0, sanitization_1.escapeHtmlForEmail)(clientIP)}</p>
          <hr>
          <p><b>Message:</b></p>
          <p>${(0, sanitization_1.escapeHtmlForEmail)(sanitizedMessage)}</p>
          <hr>
...
exports.testContactForm = functions.https.onRequest((req, res) => {
    res.json({
...
exports.subscribeToNewsletter = functions.https.onRequest((req, res) => {
    return cors(req, res, async () => {
        var _a, _b, _c, _d;
        if (req.method !== "POST") {
            res.status(405).send("Method not allowed");
        ...
        const validation = (0, sanitization_1.sanitizeNewsletterForm)({ name, email });
        if (!validation.isValid) {
...
exports.getContactStats = functions.https.onRequest((req, res) => {
    return cors(req, res, async () => {
        try {
            ...
            const newsletterSubscribers = contactsSnapshot.docs.filter(doc => doc.data().newsletter === true).length;
            res.json({
                totalContacts,
                totalSubscribers,
...
exports.getStorageUsage = functions.https.onRequest((req, res) => {
    return cors(req, res, async () => {
        var _a;
        try {
            const bucket = admin.storage().bucket(getDefaultBucketName());
            let totalBytes = 0;
            let nextQuery = { autoPaginate: false };
            do {
                ...
                nextQuery.pageToken = queryResult === null || queryResult === void 0 ? void 0 : queryResult.pageToken;
            } while (nextQuery.pageToken);
            const bytesRemaining = Math.max(0, FREE_TIER_STORAGE_BYTES - totalBytes);
            const percentUsed = Math.min(100, Number(((totalBytes / FREE_TIER_STORAGE_BYTES) * 100).toFixed(2)));
            res.json({
                totalBytes,
            ...
            if ((error === null || error === void 0 ? void 0 : error.code) === 404 || ((_a = error === null || error === void 0 ? void 0 : error.message) === null || _a === void 0 ? void 0 : _a.includes('bucket does not exist'))) {
                res.json({
                    totalBytes: 0,
                    freeTierBytes: FREE_TIER_STORAGE_BYTES,
...
function getThumbnailUrl(thumbnails) {
    var _a, _b, _c;
    if ((_a = thumbnails === null || thumbnails === void 0 ? void 0 : thumbnails.maxres) === null || _a === void 0 ? void 0 : _a.url)
        return thumbnails.maxres.url;
    if ((_b = thumbnails === null || thumbnails === void 0 ? void 0 : thumbnails.high) === null || _b === void 0 ? void 0 : _b.url)
        return thumbnails.high.url;
    if ((_c = thumbnails === null || thumbnails === void 0 ? void 0 : thumbnails.default) === null || _c === void 0 ? void 0 : _c.url)
 ...
 */
function stripBoilerplateFromDescription(description) {
...
exports.syncYouTubeUploads = functions.pubsub
    ...
    try {
        ...
        const youtubeApiKey = ((_a = functions.config().youtube) === null || _a === void 0 ? void 0 : _a.api_key) || process.env.YOUTUBE_API_KEY;
        const playlistId = ((_b = functions.config().youtube) === null || _b === void 0 ? void 0 : _b.uploads_playlist_id) || process.env.YOUTUBE_UPLOADS_PLAYLIST_ID || 'UUf0MDB_oF7huA78BNADx9sQ';
        const authorEmail = ((_c = functions.config().youtube) === null || _c === void 0 ? void 0 : _c.author_email) || process.env.YOUTUBE_AUTHOR_EMAIL || '';
        const authorId = ((_d = functions.config().youtube) === null || _d === void 0 ? void 0 : _d.author_id) || process.env.YOUTUBE_AUTHOR_ID || '';
        if (!youtubeApiKey) {
        ...
        try {
            ...
            playlistData = JSON.parse(playlistResponseText);
        }
        catch (error) {
        ...
        const videoStatus = videoData.items[0].status;
        if ((videoStatus === null || videoStatus === void 0 ? void 0 : videoStatus.privacyStatus) !== 'public') {
            console.log(`Video ${newestVideoId} is not public (${videoStatus === null || videoStatus === void 0 ? void 0 : videoStatus.privacyStatus}), skipping`);
            return null;
        }
...
exports.backfillYouTubeUploads = functions.https.onRequest(async (req, res) => {
    var _a, _b, _c, _d, _e, _f;
    try {
        // Security: Check token
        const providedToken = req.query.token;
        const expectedToken = ((_a = functions.config().youtube) === null || _a === void 0 ? void 0 : _a.backfill_token) || process.env.YOUTUBE_BACKFILL_TOKEN;
        ...
        console.log('Token check:', {
            ...
            configExists: !!((_b = functions.config().youtube) === null || _b === void 0 ? void 0 : _b.backfill_token),
        ...
        // Get config
        const youtubeApiKey = ((_c = functions.config().youtube) === null || _c === void 0 ? void 0 : _c.api_key) || process.env.YOUTUBE_API_KEY;
        const channelId = ((_d = functions.config().youtube) === null || _d === void 0 ? void 0 : _d.channel_id) || process.env.YOUTUBE_CHANNEL_ID || 'UCf0MDB_oF7huA78BNADx9sQ';
        const authorEmail = ((_e = functions.config().youtube) === null || _e === void 0 ? void 0 : _e.author_email) || process.env.YOUTUBE_AUTHOR_EMAIL || '';
        const authorId = ((_f = functions.config().youtube) === null || _f === void 0 ? void 0 : _f.author_id) || process.env.YOUTUBE_AUTHOR_ID || '';
        if (!youtubeApiKey) {
        ...
        while (processedCount < MAX_VIDEOS) {
            ...
            for (const item of searchData.items) {
                ...
                const videoStatus = videoData.items[0].status;
                if ((videoStatus === null || videoStatus === void 0 ? void 0 : videoStatus.privacyStatus) !== 'public') {
                    console.log(`Video ${videoId} is not public (${videoStatus === null || videoStatus === void 0 ? void 0 : videoStatus.privacyStatus}), skipping`);
                    skippedCount++;
                    continue;
                }
                const snippet = videoData.items[0].snippet;
