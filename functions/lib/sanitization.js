...
exports.sanitizeContactForm = sanitizeContactForm;
exports.sanitizeNewsletterForm = sanitizeNewsletterForm;
exports.escapeHtmlForEmail = escapeHtmlForEmail;
 ...
 * Check for spam trigger words
 */
function containsSpamTriggers(input) {
    if (!input || typeof input !== 'string') {
        return false;
    }
 ...
 */
function sanitizeNewsletterForm(data) {
    const errors = [];
    // Validate required fields
    if (!data.name || typeof data.name !== 'string') {
        errors.push('Name is required and must be a string');
